        ...
        <div class="row">
            <div class="form-group col-md-4 mt-3">
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="title_en" name="title_en" value="{{$blog->title_en}}">
                </div>
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea class="form-control" id="description_ar" name="description_en" placeholder="@lang('Your Description en*')"
                        style="height: 112px">{{$blog->description_en}}</textarea>
                </div>
            </div>
            ...
            <div class="form-group col-md-4 mt-3">
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="title_ar" name="title_ar" value="{{$blog->title_ar}}">
                </div>
                <div class="form-group mb-2">
                    <!-- textarea input-->
                    ...
                    <textarea class="form-control" id="description_ar" name="description_ar" placeholder="@lang('Your Description ar*')"
                        style="height: 112px">{{$blog->description_ar}}</textarea>
                </div>
            ...
            <div class="form-group col-md-4 mt-3">
                ...
                <img style="height: 30vh" src="{{asset($blog->image)}}" class="img-thumbnail" alt="">
