         ...
         <section class="page-section" id="contact">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">@lang('contactus')</h2>
                </div>
                <!-- * * * * * * * * * * * * * * *-->
                ...
                <!-- to get an API token!-->
                <form id="contactForm" action={{route('contact.store', app()->getLocale())}} method="POST">
                    @csrf
                    <div class="row align-items-stretch mb-1">
                        <div class="col-md-6" style="text-align: {{app()->getLocale()=='en'?"left":'right'}}">
                            <h3 class="colorLogo">@lang('contactus')</h3>
                            ...
                            <div class="form-group mb-3">
                                <!-- textarea input-->
                                <textarea class="form-control" id="message" name="message" placeholder="@lang('Your Message *')" style="height: 112px"></textarea>
                            </div>
                            <div class="col-md-12" style="text-align: {{app()->getLocale()=='en'?"left":'right'}}">
                                <div class="d-none" id="submitErrorMessage"><div class="text-center text-danger">Error sending message!</div></div>
                                <div  style="position: inline-block;"><button class="btn btn-primary btn-xl text-uppercase mt-0" type="submit">@lang('Send')</button></div>
                            </div>
                        </div>
                        <!-- ourLocation -->
                        <div class="col-md-6" style="text-align: {{app()->getLocale()=='en'?"left":'right'}}">
